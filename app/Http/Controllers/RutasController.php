...
class RutasController extends Controller
{
    ...
    {
        $this->middleware('calendario',['only'=>['edit','show']]);
...
///////////////////////////////////// Destinos ///////////////////////
        ...
        ->where('destinos.id',$destino_id)
        ->where('viajes.id',$id)
        ->select('viajes.id as i','destinos.dep_inicio as ini','destinos.origen as o','destinos.destino as d','destinos.ruta as r','destinos.dep_final as fin','rutas.kilome as k','destinos.tiempo as t')
        ->distinct()
        ->get();
        //dd($destinos);
        ...
        ->where('destinos.id',$dest1)
        ->where('viajes.id',$id)
        ->select('viajes.id as i','destinos.dep_inicio as ini','destinos.origen as o','destinos.destino as d','destinos.dep_final as fin','destinos.ruta as r','rutas.k1 as k','destinos.tiempo as t')
        ->distinct()
        ->get();
        //dd($desti1);
        ...
        ->where('destinos.id',$dest2)
        ->where('viajes.id',$id)
        ->select('viajes.id as i','destinos.dep_inicio as ini','destinos.origen as o','destinos.destino as d','destinos.dep_final as fin','destinos.ruta as r','rutas.k2 as k','destinos.tiempo as t')
        ->distinct()
        ->get();
        //dd($desti2);
        ...
        ->where('destinos.id',$dest3)
        ->where('viajes.id',$id)
        ->select('viajes.id as i','destinos.dep_inicio as ini','destinos.origen as o','destinos.destino as d','destinos.dep_final as fin','destinos.ruta as r','rutas.k3 as k','destinos.tiempo as t')
        ->distinct()
        ->get();
        //dd($desti3);
        ...
        ->where('destinos.id',$dest4)
        ->where('viajes.id',$id)
        ->select('viajes.id as i','destinos.dep_inicio as ini','destinos.origen as o','destinos.destino as d','destinos.dep_final as fin','destinos.ruta as r','rutas.k4 as k','destinos.tiempo as t')
        ->distinct()
        ->get();
        //dd($desti4);
        ...
        ->where('destinos.id',$dest5)
        ->where('viajes.id',$id)
        ->select('viajes.id as i','destinos.dep_inicio as ini','destinos.origen as o','destinos.destino as d','destinos.dep_final as fin','destinos.ruta as r','rutas.k5 as k','destinos.tiempo as t')
        ->distinct()
        ->get();  
        //dd($desti5);
        $adici = Ruta::where('viaje_id',$id)
        ...
        //dd($date);
        $view =  \View::make('automotores.viajes.pdf', compact('viaje','date', 'choferes','encargados','vehiculos','destinos','desti1','desti2','desti3','desti4','desti5','adici','total','responsable'));
        $pdf  = \App::make('dompdf.wrapper');
        $pdf->loadHTML($view)->setPaper('carta','portrait')->stream();
        return $pdf->stream('rutas');
