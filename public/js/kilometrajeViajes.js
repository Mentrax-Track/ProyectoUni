...
/**
     ...
     function sumar()
    {
        ...
        document.getElementById("total").value=(parseFloat(kilome)+parseFloat(k1)+parseFloat(k2)+parseFloat(k3)+parseFloat(k4)+parseFloat(k5)+parseFloat(adicional)).toFixed(2);
