...
<div class="panel panel-success">
    ...
    <div class="panel-heading text-center"><h4><p class="www">Realizar petición de material</p></h4></div>
    <div class="panel-body jumbotron">      
       {!! Form::open(['route'=>'peticion.store','method'=>'POST','data-toggle'=>'validator']) !!}
