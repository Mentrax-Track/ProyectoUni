        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select id="status" name="status" onChange="mostrar(this.value);" class="form-control">
                        ...
                        <option value="tipoa"> Presupuesto con Cheque</option>
                        <option value="tipob"> Presupuesto por Caja</option>
                </select>
            </div>
        </div>
        <div class="col-md-4"></div>
...
<div id="tipoa" class="element" style="display: none;">

    <center><h2><p class="www">Formulario del presupuesto con cheque</p></h2></center>
          ...
          <div class="jumbotron text-center">
            <div class="row">
              <div class="col-md-4">
                ...
                {!! Form::select('vehiculo',$vehiculos,null,['class'=>'form-control','placeholder'=>'Seleccione un Vehiculo','data-error'=>'Seleccione un Vehículo','required','id'=>'vehis']) !!}
              ...
              <div class="col-md-4">
                ...
                {!! Form::select('chofer',$choferes,null,['class'=>'form-control','id'=>'chofs','placeholder'=>'Seleccione un chofer','data-error'=>'Seleccione a un Chofer','required']) !!}
                <center><div class="help-block with-errors"></div></center>
              </div>
              <div class="col-md-4">
                <div>
                ...
                {!! Form::select('encargado',$encargados,null,['class'=>'form-control','placeholder'=>'Seleccione un responsable','data-error'=>'Seleccione a un Encargado','required','id'=>'encars']) !!}
                 <center><div class="help-block with-errors"></div></center>
              </div>
            </div><hr>
            <div class="row">
...
<div id="tipob" class="element" style="display: none;">
    <center><h2><p class="www">Formulario Presupuesto por Caja</p></h2></center>
