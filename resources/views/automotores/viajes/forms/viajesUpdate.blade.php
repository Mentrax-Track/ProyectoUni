...
<div class="col-md-4">
    <ul class="list-group">
        ...
        <li class="list-group-item list-group-item-success">
            ...
            {!! Form::number('pasajeros',null,['class'=>'form-control', 'placeholder'=>'Ejm. 20','data-error'=>'Inserte el número de pasajeros','required']) !!}
            <center><div class="help-block with-errors"></div></center>
        </li>
        <li class="list-group-item list-group-item-success">
            <center>
        ...
        <li class="list-group-item list-group-item-info">
            <div class='input-group date ' id='datetimepicker6'>
                {!! Form::text('fecha_inicial',$viaje->fecha_inicial,['class'=>'form-control', 'placeholder'=>'Ingrese la fecha de inicio','data-error'=>'Inserte la fecha Inicial','required']) !!}
                <center><div class="help-block with-errors"></div></center>
        ...
        <li class="list-group-item list-group-item-info">
            <div class='input-group date ' id='datetimepicker7'>
                {!! Form::text('fecha_final',$viaje->fecha_final,['class'=>'form-control', 'placeholder'=>'Ingrese la fecha final','data-error'=>'Inserte la fecha Final','required']) !!}
                <center><div class="help-block with-errors"></div></center>
                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
        ...
        <li class="list-group-item list-group-item-info col-md-12">
            <div class="form-inline">
                <div class="form-group col-md-3">
                    ...
                    {!! Form::text('entidad',null,['class'=>'js-example-responsive', 'placeholder'=>'Entidad responsable','style'=>'width: 100%','role'=>'search','id'=>'entidad','data-error'=>'Seleccione una Entidad','required']) !!}
                    <center><div class="help-block with-errors"></div></center>
                </div>
                <div class="form-group col-md-2"></div>
                <div class="form-group col-md-7">
                    <label for="objetivo">Objetivo:</label>
                    {!! Form::textarea('objetivo',null,['class'=>'form-control', 'placeholder'=>'Ingrese el objetivo del viaje','style'=>'width: 100%','data-error'=>'Inserte el objetivo del viaje','required','rows'=>1,'id'=>'objetivo']) !!}
                    <center><div class="help-block with-errors"></div></center>
                </div>
            </div>
        </li>
