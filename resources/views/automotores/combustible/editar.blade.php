...
@section('subtitulo','Editar la recarga de combustible')
...
<div class="panel panel-success">
    <div class="panel-heading text-center"><h4><p class="www">Editar la recarga de combustible</p></h4></div>
    <div class="panel-body jumbotron"> 

            {!!Form::model($prueba,['route'=> ['combustibles.update',$prueba->id],'method'=>'PUT'])!!}
