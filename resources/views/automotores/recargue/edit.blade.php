...
<div class="panel panel-success">
    ...
    <div class="panel-heading text-center"><h4><p class="www">Editar la recarga</p></h4></div>
    <div class="panel-body jumbotron">      
       {!!Form::model($recargue,['route'=> ['recargues.update',$recargue->id],'method'=>'PUT'])!!}
            <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
            @include('automotores.recargue.forms.vehiUpdate')
            <div class="row">
        ...
        {!! Form::close() !!}
      <br>
        {!! Form::open(['route'=>['recargues.destroy',$recargue->id],'method'=>'DELETE']) !!}
            <div class="row">
                <div class="col-md-4"></div>
                <div class="col-md-4">
                <center>
