...
<div class="panel panel-success">
    <div class="panel-heading text-center"><h4><p class="www">Detalle del vehículo con placa {{$placa->placa}} </p></h4></div>
            ...
            <div class="col-md-12">
                <table class='table table-bordered table-hover table-condensed jumbotron'>
                    ...
                    <tr class="info">
                        ...
                        <th><u>Tipo Específico:</u> {{$modelo->tipoe}}</th>
                    </tr>
                    <tr class="info">
                        <th><u>Marca:</u> {{$marca->marca}} </th>
                        <th><u>Chasís:</u> {{$marca->chasis}} </th>
