...
<div class="panel panel-default">
  ...
  <div class="panel-body text-center jumbotron">
    <div class="row">
      <div class="col-md-9">
        {!! Form::label('Ruta:') !!}
        {!! Form::select('destino_id[]',$destino_id,null,['class'=>'js-example-responsive','style'=>'width: 100%','disabled']) !!}
      </div>
      <div class="col-md-3">
        {!! Form::label('Km') !!}            
    ...
    <div class="row">
      <div class="col-md-9">
        {!! Form::select('dest1[]',$dest1,null,['class'=>'js-example-responsive','style'=>'width: 100%','disabled']) !!}
      </div>
      <div class="col-md-3">
    ...
    <div class="row">
      <div class="col-md-9">
        {!! Form::select('dest2[]',$dest2,null,['class'=>'js-example-responsive','style'=>'width: 100%','disabled']) !!}
      </div>
      <div class="col-md-3">
    ...
    <div class="row">
      <div class="col-md-9">
        {!! Form::select('dest3[]',$dest3,null,['class'=>'js-example-responsive','style'=>'width: 100%','disabled']) !!}
      </div>
      <div class="col-md-3">
    ...
    <div class="row">
      <div class="col-md-9">
        {!! Form::select('dest4[]',$dest4,null,['class'=>'js-example-responsive','style'=>'width: 100%','disabled']) !!}
      </div>
      <div class="col-md-3">
    ...
    <div class="row">
      <div class="col-md-9">
        {!! Form::select('dest5[]',$dest5,null,['class'=>'js-example-responsive','style'=>'width: 100%','disabled']) !!}
      </div>
      <div class="col-md-3">
